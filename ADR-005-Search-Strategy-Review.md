...
## Topik: Search Strategy — Real Estate Agency Platform
...
11. `API-Specification-Real-Estate-Agency-Platform-v1.1.md` §3 — tambahkan catatan implementasi resmi (Postgres FTS Fase 1) di bawah judul bagian, menggantikan catatan lama "direkomendasikan didukung Typesense/Elasticsearch" agar tidak menyesatkan sesi development berikutnya.
...
Agency-Platform-v1.1.md, API-Specification-Real-Estate-Agency-Platform-
v1.1.md §3.
