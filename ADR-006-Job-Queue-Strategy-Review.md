...
## Topik: Job Queue Strategy — Real Estate Agency Platform
...
14. `ERD-Skema-Database-Real-Estate-Agency-Platform-v1.1.md` — dokumentasikan trigger counter sync dan (opsional) tabel `job_execution_log`.
15. `SEO-Analytics-Specification-Real-Estate-Agency-Platform-v1.1.md` — catatan implementasi resmi (§1.5, §4.3) bahwa sitemap regeneration & Indexing API call dijalankan via Database Webhook → Route Handler.
...
project-manifest.md, ERD-Skema-Database-Real-Estate-Agency-Platform-v1.1.md,
