...
4. Pilihan framework frontend yang mendukung SSR/SSG (lihat SEO Specification Bagian 1.1) — menentukan detail implementasi Bagian 10 di atas.
5. Siapa pemegang akun organisasi (bukan akun pribadi) untuk Google Search Console, Google Tag Manager, dan GA4.
