...
| Fase | Cakupan |
|---|---|
| **Fase 1 (MVP)** | Modul 1, 2, 3 (dasar), 9 (admin dasar), 10 (RBAC dasar: Superadmin/Admin/Agen) — agen bisa daftar, isi profil, posting listing, dengan pembatasan akses by role sejak awal |
