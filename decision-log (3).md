...
| **Last Updated** | 29 Juli 2026 (penambahan ADR-040 — sinkronisasi keputusan Job Queue Strategy dari `architecture-decision-records.md` ADR-006) |
...
|---|---|---|
| **Architecture** | Keputusan struktural lintas sistem | ADR-001, 002, 029, 031, 036, 039, 040 |
...
| **Backend** | Service layer, integrasi pihak ketiga, PDF/email | ADR-003, 010, 025, 026, 028, 039, 040 |
